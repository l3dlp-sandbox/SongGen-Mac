...
from sse import (notify_queue_update, notify_generation_update as sse_notify_gen, notify_library_update as sse_notify_lib, notify_models_update, notify_models_update_sync)
...
async def sse_endpoint(): return Response(status_code=410)
