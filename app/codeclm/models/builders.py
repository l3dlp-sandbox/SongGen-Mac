...
def _is_flash_attn_available() -> bool:
    """Check if Flash Attention is actually available and usable."""
    try:
...
def get_lm_model(cfg: omegaconf.DictConfig): #-> LMModel:
    ...
    if lm_kwargs.get('use_flash_attn_2', False) and not _is_flash_attn_available():
        print("[BUILDERS] Flash Attention 2 requested but not available, disabling...", flush=True)
        lm_kwargs['use_flash_attn_2'] = False
